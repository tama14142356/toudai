...
\item 以降$\arctan x$の定義域は$-\frac{\pi}{2} < x < \frac{\pi}{2}$であるとする.
  ...
  \begin{equation*}
    f(x) = \frac{4}{3\pi\left\{\left(2x + 1\right)^2 + x^2\right\}}  -1\, \leq\, x \, \leq 0
  \end{equation*}
  \vspace{0.7cm}
...
\item 設問\eqref{subsec3:prom3}より辺$\mathrm{BC}$上に点$\mathrm{Q}$
  ...
  \begin{align*}
    \alpha &= \dint{-1}{0}{xf(x)}\\
          &= \dint{-1}{0}{\frac{4}{3\pi}\frac{x}{\left(2x + 1\right)^2 + x^2}}\\
          &= \frac{4}{3\pi}\dint{-1}{0}{\frac{1}{10}\left(\frac{10x + 4}{\left(2x + 1\right)^2 + x^2} - \frac{4}{\left(2x + 1\right)^2 + x^2}\right)}\\
  ...
  \begin{eqnarray*}
    \alpha &=& \int_{-1}^{0}xf(x)\ {\rm d}x\\
           ...
           &=& \frac{2}{15\pi}\left(-\log 2-\left[4\cdot 5\cdot \frac{1}{5}\cdot {\rm Arctan} \left\{5\cdot \left(x+\frac{2}{5}\right)\right\}\right]_{-1}^{0}\right)\\
           &=& \frac{2}{15\pi}\Bigl\{-\log 2-4\cdot \left({\rm Arctan}2+{\rm Arctan 3}\right)\Bigr\}\\
           &=& \frac{2}{15\pi}\left\{-\log 2-4\cdot \left(\frac{3\pi}{4}\right)\right\}\\
           &=& -\frac{2}{15\pi}\log 2-\frac{2}{5}
  \end{eqnarray*}
\item まず,点$\mathrm{Q}$が辺$\mathrm{AC}$上にある時の$X$の期待値$\delta$を求める.
  ...
  \begin{align*}
    \delta &= \dint{-1}{1}{xf(x)}\\
          ...
          &= \frac{8}{3\pi}\dint{-1}{1}{\frac{1}{10}\left[\frac{10x - 2}{\left\{\left(x - 1\right)^2 + 4x^2\right\}} + \frac{2}{\left\{\left(x - 1\right)^2 + 4x^2\right\}}\right]}\\
          &= \frac{4}{15\pi}\dint{-1}{1}{\left[\frac{10x - 2}{\left\{\left(x - 1\right)^2 + 4x^2\right\}} + \frac{2}{\left\{\left(x - 1\right)^2 + 4x^2\right\}}\right]}\\
          ...
          &= -\frac{4}{15\pi}\log 2 + \frac{8}{15\pi}\dint{-1}{1}{\frac{5}{4\frac{25}{4}(x - \frac{1}{5})^2 + 1}}\\
